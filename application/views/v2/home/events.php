    ...
    <table class="table table-sm">
        ...
        <tbody>
		    ...
		    <tr>
		        ...
		        <td style="text-align: right;"><small><?php echo isset($tnews['org_author']) && strlen($tnews['org_author'])>1 ? "<b>".$tnews['org_author'] . "</b>" : $tnews['author'] ; ?></small></td>
		        <td style="white-space: pre; font-family: monospace; text-align: center;"><?php echo str_pad($tnews['comtclicks'], 4, '    ', STR_PAD_LEFT); ?>/<?php echo str_pad($tnews['viewclicks'], 4, '    ', STR_PAD_RIGHT); ?></td>
