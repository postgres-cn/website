...
public function index($mainver=FALSE){  
  ...
  $this->load->view('v2/release/list', $data);
...
public function v($sysid = 0){  
  ...
  $this->load->view('v2/templates/header',$data);
  $this->load->view('v2/release/viewone', $data);
  $this->load->view('v2/templates/footer');
...
public function create(){
  ...
  {
    $this->load->view('v2/templates/header', $data);  
    $this->load->view('v2/release/publication',$data);
    $this->load->view('v2/templates/footer');
	 ...
	 $relid = $this->release_model->save_release();
	    ...
	    $this->act_model->add_point_byid($act_id,30,'新版发布','<a href=/v2/release/v/'.$relid.'>浏览' . $relid .'号版本发布声明</a>') ; 
	...
	$data['relid'] = $relid ; 
	   ...
	   $this->load->view('v2/templates/header', $data);  
	   $this->load->view('v2/release/success_pub',$data);
	   $this->load->view('v2/templates/footer');
   }
