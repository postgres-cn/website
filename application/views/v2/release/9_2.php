...
<div class=banner>首页 --> PostgreSQL 9.2版本发布说明</div><br><br>
...
<p>
2012/09/10: PostgreSQL全球开发组宣布业界领先的开源关系数据库PostgreSQL9.2版发布，由于Beta测试版本在5月即已发布，开发人员和软件厂商称赞该版本在性能、可扩展性和灵活性方面得到大的提升。大量的用户期待切换至新的版本。
</p>
...
<ul>
<li>最高可达每秒350,000次读查询 (相比以前快4倍)</li>
<li>数据仓库中只使用索引扫描的查询(最高可比以前快20倍)</li>
<li>最高可达每秒14,000次数据写操作(相比以前快5倍)</li>
</ul>
<p>
...
<p>
<b>关于PostgreSQL</b>: 
PostgreSQL是业内领先的开源数据库系统，它的开发和支持来自于一个由数千名用户组成的全球社区和全球几十家公司或组织，PostgreSQL项目有25年以上的历史，起源于加利福利亚的伯克利大学，经历了无数次开发升级。PostgreSQL的专业特性不仅包含最高级的商业数据库系统的功能，还在高级数据库特性、扩展性、安全性和稳定性方面超越了它们，更多详情可浏览：<a href="http://www.postgresql.org">PostgreSQL.org</a>网站。
</p>

<h2>新版本发布说明（扩充部分）</h2>

<a name="features"></a><h2>特性列表</h2>
...
<li><a href="/ftp/source/v9.2.0">源代码</a></li>
<li><a href="http://code.google.com/p/plv8js/downloads/list">PL/v8 和 PL/Coffee</a></li>
...
<p>
HTML 格式文档和 man 格式的文档随PostgreSQL一起安装，用户也可以免费地在网站上对<a href="/docs/9.2/interactive">在线文档</a>进行浏览、搜索和反馈评论。
</p>

<a name="license"></a><h2>版本声明</h2>
<p>
PostgreSQL 使用<a href="/about/licence">PostgreSQL版权声明</a>，它是类似BSD的版权，只要求对有版权的源代码保留其版权和授权的信息即可。
...
<p>
<b>EngineYard</b> 公司是一家领先的 <a href="http://www.engineyard.com/platform-as-a-service">平台服务(PaaS)</a>软件商，提供更加快捷、简便和低成本的<a href="http://www.engineyard.com/products/cloud">云应用开发</a> 环境。 通过专业的技术支撑、强大的基础架构、开源社区的有力支持，以及世界级水平的服务，Engine Yard公司提供了一整套的商业级解决方案，可以使开发人员集中精力创建他们的应用，免去他们自己管理平台的烦恼。现已在58个国家有上千名客户，包括会有爆炸式增长的Web创新公司到财富500强企业，都通过Engine Yard获得了在云应用方面的竞争优势。其总部设于加州三藩市，Engine Yard公司的背后由Benchmark基金，NEA 恩颐投资和 亚马逊的投资支持。联系人：<a href="mailto:mhick@bhavacom.com">Melissa Hick</a>, 510-984-1525
</p>

<p>
<b><a href="http://newsblur.com">NewsBlur</a></b>网站是一个社会新闻阅读网站。NewsBlur网站上可以浏览到你的朋友们和你最喜爱的博客上最棒的故事。联系人（仅英语）：<a href="mailto:samuel@newsblur.com">Samuel Clay</a>
</p><p>
<b><a href="http://www.ivc.com">IVC公司</a></b> 是一家提供技术服务的商业公司，座落于美国北卡罗来纳州的三角科学园区，自1987年开始即提供完整的短期或长期技术解决方案。IVC公司开发并提供客户关系管理、特殊集成、数据分析和移动应用等多种技术解决方案。我们基于数据库的软件应用，现每天都被数百家财富前1000家公司在使用，如时代华纳有线电视、, 阿斯利康、凯撒、进步能源、嘉信证券 和 道富银行等。联系人（仅英语）：<a href="mailto:steve@ivc.com">Steve</a>, (919) 439-7792
</p>
