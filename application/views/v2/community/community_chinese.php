    ...
    <div class="col-md-9">
        <div class="well">
            ...
            <div class="well well-sm">
                <h4><strong>协会管理委员分工情况...   任期:2018-12-15 ---- 2020-12-15 </strong></h4>
                <table class="table">
                    <tr>
                        <th>职责</th>
                        <th>名单</th>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <li>制约：45天内无内部会议视为自动辞职；或1/3以上常委弹劾的，重选。</li>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <li>职能：发展统筹，工作分配，整体进度跟踪</li>
                            <li>权利：1票否决权，但没有强制执行权；投票数+1（1票等于2票）</li>
                            <li>制约：45天内无内部会议视为自动辞职；或1/3以上常委弹劾的，重选。</li>
                        </td>
                    </tr>
                    <tr>
                        <td align=center>委员核心组</td>
                        <td>萧少聪、周正中、汪洋、<br>张文升、陈河堆、朱贤文、<br>李海龙、周到京、白国华、<br>姜明俊、谭峰、胡辉、<br>王硕、陈华军、秦红胜、<br>刘泉、胡怡文、<br>彭煜玮、胡森、姚延栋
                        </td>
                        <td>
