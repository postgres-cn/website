            ...
            <div class="well well-sm">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>周正中<br>彭煜玮<br>唐成<br>赵振平<br>刘媛媛</td>
                        <td>
                            <li>权利：投票数+1（1票等于2票）；主席弹劾权</li>
                            <li>制约：3个月不在重要会议出现自动免职，核心组重新选1人</li>
                        </td>
                    </tr>
                    <tr>
                        <td align=center>核心组</td>
                        <td>刘奎恩、陈华军<br>朱贤文、张文升<br>周到京、吴仁锦<br>金华峰、胡怡文<br>李鹏宇、杨楂文<br>权宗亮、王硕<br>黄坚、谭峰
                        </td>
                        <td>
